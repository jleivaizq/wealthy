...
class PropertiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create property" do
    assert_difference("Property.count") do
      post properties_url, params: { property: { address: @property.address, bathrooms: @property.bathrooms, bedrooms: @property.bedrooms, city: @property.city, comments: @property.comments, link: @property.link, meters: @property.meters, postal_code: @property.postal_code, price: @property.price, rating: @property.rating, title: @property.title } }
    end
